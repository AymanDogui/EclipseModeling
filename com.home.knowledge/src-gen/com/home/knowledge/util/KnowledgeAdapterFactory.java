...
public class KnowledgeAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected static MKnowledgePackage modelPackage;
	...
	public KnowledgeAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = MKnowledgePackage.eINSTANCE;
		}
	}
	...
	protected KnowledgeSwitch<Adapter> modelSwitch =
		new KnowledgeSwitch<Adapter>() {
			@Override
			public Adapter caseExperience(MExperience object) {
				return createExperienceAdapter();
			}
			@Override
			public Adapter caseProblem(MProblem object) {
				return createProblemAdapter();
			}
			@Override
			public Adapter caseSolution(MSolution object) {
				return createSolutionAdapter();
			}
			@Override
			public Adapter caseOrganisation(MOrganisation object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.home.knowledge.MExperience <em>Experience</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.home.knowledge.MProblem <em>Problem</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.home.knowledge.MSolution <em>Solution</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.home.knowledge.MOrganisation <em>Organisation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
